...
# doesn't have built-in constant types, but Pythn programmers use all capital letters to indicate a
# variable should be treated as a constant and never be changed:

# MAX_CONNECTIONS = 5000

# When you treat a variable as a constant in your code, make the name of the variable all captial
# letters.
